...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_READ_ONLY_TRANSACTION = 1207; //SQLSTATE: 25000 Message: etape1à5.Update locks cannot be acquired during a READ UNCOMMITTED transaction
    ...
    public final static int ER_SELECT_REDUCED = 1249; //SQLSTATE: 01000 Message: etape1à5.Select %u was reduced during optimization
    ...
    public final static int ER_NO_GROUP_FOR_PROC = 1385; //SQLSTATE: HY000 Message: etape1à5.Select must have a group with this procedure
    ...
    public final static int ER_NON_RO_SELECT_DISABLE_TIMER = 1908; //SQLSTATE: HY000 Message: etape1à5.Select is not a read only statement, disabling timer; was introduced in 5.7.4.
